...
2. from the list filter which elements are not divisible by 5 and 3.
...
for i in orgList:
    # this is checking condition for inside the list which elements are not divisible by 5 and 3.
    if(i % 3 != 0) and (i % 5!=0):
