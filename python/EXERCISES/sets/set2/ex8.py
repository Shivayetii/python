...
for i in orgList:
    # this is checking condition for inside the list which elements are not even elements
    if(i %2!= 0):
        # to add new elements inside the list which elements are not even elements
        newList.append(i)
